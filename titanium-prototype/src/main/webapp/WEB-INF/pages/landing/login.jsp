...
<body class="login">
	...
	<div class="content">
		...
		<form class="form-vertical login-form" action="/pub/index">
			...
			<div class="form-actions">
				...
				<button type="submit" class="btn blue pull-right" id="loginButton">
	...
	<script src="${ctx}/static/js/jquery.backstretch.min.js" type="text/javascript"></script>

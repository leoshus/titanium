...
<body class="page-header-fixed">
					...
					<li class="dropdown" id="header_inbox_bar">
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li>
								...
								<span class="photo"><img src="${ctx}/static/image/avatar3.jpg" alt="" /></span>
							...
							<li>
								...
								<span class="photo"><img src="${ctx}/static/image/avatar1.jpg" alt="" /></span>
							...
							<div class="portlet solid bordered light-grey">
								...
								<div class="portlet-body">
									...
									<div id="site_statistics_loading">
										...
										<img src="${ctx}/static/image/loading.gif" alt="loading" />
												...
												<div class="scroller" data-height="290px" data-always-visible="1" data-rail-visible1="1">
													...
													<div class="row-fluid">
														...
														<div class="span6 user-info">
															...
															<img alt="" src="${ctx}/static/image/avatar.png" />
									...
									<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
										...
										<ul class="chats">
											...
											<li class="in">
												...
												<img class="avatar" alt="" src="${ctx}/static/image/avatar1.jpg" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="${ctx}/static/image/avatar2.jpg" />
											...
											<li class="out">
												...
												<img class="avatar" alt="" src="${ctx}/static/image/avatar3.jpg" />
	...
	<script src="${ctx}/static/js/jquery.vmap.js" type="text/javascript"></script>   

	<script src="${ctx}/static/js/jquery.vmap.russia.js" type="text/javascript"></script>

	<script src="${ctx}/static/js/jquery.vmap.world.js" type="text/javascript"></script>

	<script src="${ctx}/static/js/jquery.vmap.europe.js" type="text/javascript"></script>

	<script src="${ctx}/static/js/jquery.vmap.germany.js" type="text/javascript"></script>

	<script src="${ctx}/static/js/jquery.vmap.usa.js" type="text/javascript"></script>

	<script src="${ctx}/static/js/jquery.vmap.sampledata.js" type="text/javascript"></script>  

	<script src="${ctx}/static/js/jquery.flot.js" type="text/javascript"></script>

	<script src="${ctx}/static/js/jquery.flot.resize.js" type="text/javascript"></script>

	<script src="${ctx}/static/js/jquery.pulsate.min.js" type="text/javascript"></script>

	<script src="${ctx}/static/js/date.js" type="text/javascript"></script>

	<script src="${ctx}/static/js/daterangepicker.js" type="text/javascript"></script>     

	<script src="${ctx}/static/js/jquery.gritter.js" type="text/javascript"></script>

	<script src="${ctx}/static/js/fullcalendar.min.js" type="text/javascript"></script>

	<script src="${ctx}/static/js/jquery.easy-pie-chart.js" type="text/javascript"></script>

	<script src="${ctx}/static/js/jquery.sparkline.min.js" type="text/javascript"></script>  
